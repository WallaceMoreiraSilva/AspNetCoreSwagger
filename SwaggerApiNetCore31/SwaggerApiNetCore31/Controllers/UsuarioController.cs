...
namespace SwaggerApiNetCore31.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(List<UsuarioViewModel>), 200)]
        ...
        [HttpPut("{id}")]
        public IActionResult Put([FromRoute]Guid id, [FromBody] UsuarioViewModel usuario)
        {
            try
            {
                var usuarios = ObterUsuarios();
        ...
        private IEnumerable<UsuarioViewModel> ObterUsuarios()
        {
            return new List<UsuarioViewModel>
            {
                new UsuarioViewModel { Id = Guid.Parse("CAEF4812-598E-4473-8EFC-B338AF69A18F"), Name = "João", Email = "joao@outlook.com" },
                new UsuarioViewModel { Id = Guid.Parse("B88DCCAF-A3A2-436F-8B09-27F0E1F73321"), Name = "José", Email = "jose@outlook.com" },
                new UsuarioViewModel { Id = Guid.Parse("1E018A4E-FC1B-4E2D-91CA-8076D60CF63F"), Name = "Maria", Email = "maria@outlook.com" }
            };
        }
    }
}